...
- [x] **Expose for production on Railway** (portfolio issue #63)
  - Production runs on Railway using `railway.toml` for build, start, and health checks.
...
- No Docker; production runs on Railway
